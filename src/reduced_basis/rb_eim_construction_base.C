...
void RBEIMConstructionBase::initialize_eim_assembly_objects()
{
  _rb_eim_assembly_objects.clear();
...
void RBEIMConstructionBase::store_eim_solutions_for_training_set()
{
  LOG_SCOPE("store_eim_solutions_for_training_set()", "RBEIMConstructionBase");
...
const RBEIMEvaluation::QpDataMap & RBEIMConstructionBase::get_parametrized_function_from_training_set(unsigned int training_index) const
{
...
std::pair<Real,unsigned int> RBEIMConstructionBase::compute_max_eim_error()
{
  LOG_SCOPE("compute_max_eim_error()", "RBEIMConstructionBase");
...
void RBEIMConstructionBase::initialize_parametrized_functions_in_training_set()
{
  LOG_SCOPE("initialize_parametrized_functions_in_training_set()", "RBEIMConstructionBase");

  libmesh_error_msg_if(!serial_training_set,
                       "Error: We must have serial_training_set==true in "
                       "RBEIMConstructionBase::initialize_parametrized_functions_in_training_set");
...
void RBEIMConstructionBase::initialize_qp_data()
{
  LOG_SCOPE("initialize_qp_data()", "RBEIMConstructionBase");
...
void RBEIMConstructionBase::initialize_observation_points_data(
  std::vector<dof_id_type> & observation_points_elem_ids,
  std::vector<subdomain_id_type> & observation_points_sbd_ids)
{
  LOG_SCOPE("initialize_observation_points_data()", "RBEIMConstructionBase");
...
Number
RBEIMConstructionBase::inner_product(const QpDataMap & v, const QpDataMap & w)
{
  LOG_SCOPE("inner_product()", "RBEIMConstructionBase");
...
Real RBEIMConstructionBase::get_max_abs_value(const QpDataMap & v) const
{
  LOG_SCOPE("get_max_abs_value()", "RBEIMConstructionBase");
...
void RBEIMConstructionBase::enrich_eim_approximation(unsigned int training_index)
{
  LOG_SCOPE("enrich_eim_approximation()", "RBEIMConstructionBase");
...
void RBEIMConstructionBase::update_eim_matrices()
{
  LOG_SCOPE("update_eim_matrices()", "RBEIMConstructionBase");
...
void RBEIMConstructionBase::scale_parametrized_function(
    QpDataMap & local_pf,
    Number scaling_factor)
{
  LOG_SCOPE("scale_parametrized_function()", "RBEIMConstructionBase");
