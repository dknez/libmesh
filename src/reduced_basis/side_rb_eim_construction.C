...
SideRBEIMConstruction::SideRBEIMConstruction (EquationSystems & es,
...
void SideRBEIMConstruction::print_info()
{
...
std::pair<Real,unsigned int> SideRBEIMConstruction::compute_max_eim_error()
{
...
void SideRBEIMConstruction::initialize_qp_data()
{
...
Number
SideRBEIMConstruction::inner_product(const SideQpDataMap & v, const SideQpDataMap & w)
{
  LOG_SCOPE("inner_product()", "SideRBEIMConstruction");
...
Real SideRBEIMConstruction::get_max_abs_value(const SideQpDataMap & v) const
{
  LOG_SCOPE("get_max_abs_value()", "SideRBEIMConstruction");
...
void SideRBEIMConstruction::enrich_eim_approximation(unsigned int training_index)
{
